...
**You Must** - Follow the [DHSC adopted style](#style_guides) for your language, use [meaningful names](#meaningful_names) and avoid [overlaps](#dont_overlap).
...
[Linters](https://en.wikipedia.org/wiki/Lint_%28software%29) are tools that you can use to ensure that you are following a given style guide.

| Language | DHSC Recommended Linter                             |
|----------|-------------------------------------------------------|
| R        | [Styler](http://styler.r-lib.org/) |
