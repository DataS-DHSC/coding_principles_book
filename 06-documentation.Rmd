...
**You Must** - Produce documentation in line with [Aqua book guidance](#aqua).

**You Should** - Assemble documentation [as you code](#as_you_go).

**You Could** - Use document generation tools to produce [documentation](#doxygen).
