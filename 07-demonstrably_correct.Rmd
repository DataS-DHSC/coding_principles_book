...
See [Testing Frameworks](testing_frameworks.md) for more details.
...
Using git for [version control](principle_version_control.md) makes this process easy. You can:
...
[Reproducible Analytical Pipelines](reproducible-analytical-pipelines.md).
