...
Often your code will be adapted, repurposed, or applied to something new. Preparing for this upfront and writing flexible code can save time later.

This does **not** mean trying to solve every conceivable problem up-front, or writing general purpose functions for problems you may never encounter. Instead focus on making your code easy to change when needed:
...
There are some common [coding styles](coding_styles.md) for breaking down a program into chunks.
