 ...
 **You Must** - Hold your code to the [same standard as regular analysis](#qa_code_too) and record evidence demonstrating it produces the right output.
 ...
 **You Could** - Make a fully automated [reproducible analytical pipeline (RAP)](#rap_demonstrable).
 
 |Related Areas: 	| [Version Control](#version_control) <br> [Be Reproducible](#reproducible) |
|---------------	|------------------------------------------------------------|

## QA Applies to Code {#qa_code_too}
