...
Commented, and well written code can go a long way to documenting how a project works. However for higher level context it will always be useful to have some separate documentation.
...
See [Aqua Book Guidance for Technical Documentation](note_aqua_technical_documentation,md) for more.
