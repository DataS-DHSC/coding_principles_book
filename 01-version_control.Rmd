...
**You Must** - Use [version control](#what_is_vc) and follow guidance on coding in the open.

**You Should** - Use standard tools ([Git](#git) & [GitHub](#github)) to help you version control code.

**You Could** - Use ([Git](#git) & [GitHub](#github)) collaboratively and [effectively](#effective_vc) and agree a version control pattern with your team.
